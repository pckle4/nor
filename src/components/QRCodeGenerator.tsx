...
const QRCodeGenerator = () => {
  ...
  useEffect(() => {
    generateQRCode();
  }, [text, foregroundColor, backgroundColor, size, errorLevel]);
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6">
          <Card className="text-center border-0 bg-white/60 backdrop-blur-sm">
            <CardContent className="pt-6">
              <Palette className="w-12 h-12 text-indigo-600 mx-auto mb-3" />
          ...
          <Card className="text-center border-0 bg-white/60 backdrop-blur-sm">
            <CardContent className="pt-6">
              ...
              <p className="text-sm text-gray-600">Customize size, error correction, and output format</p>
            </CardContent>
          </Card>
          <Card className="text-center border-0 bg-white/60 backdrop-blur-sm">
            <CardContent className="pt-6">
              ...
              <p className="text-sm text-gray-600">Download your QR codes in multiple formats instantly</p>
            </CardContent>
          </Card>
        </div>
      </div>
